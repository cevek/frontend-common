...
angular.module('ui.bootstrap.accordion', ['ui.bootstrap.collapse'])
    ...
    .controller('AccordionCtrl', ['$scope', '$attrs', 'accordionConfig', function($scope, $attrs, accordionConfig){
...
angular.module('ui.bootstrap.carousel', ['ui.bootstrap.transition'])
    .controller('CarouselCtrl', ['$scope', '$timeout', '$transition', '$q', function($scope, $timeout, $transition, $q){
        var self = this,
            slides = self.slides = [],
            currentIndex = -1,
...
dialogModule.controller('MessageBoxCtrl', ['$scope', 'dialog', 'model', function($scope, dialog, model){
...
dialogModule.provider("$dialog", function(){
    ...
    this.$get = ["$http", "$document", "$compile", "$rootScope", "$controller", "$templateCache", "$q", "$transition", "$injector",
        function($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector){
            ...
            //
            //     var d = new Dialog({templateUrl: 'foo.html', controller: 'BarCtrl'});
            //
            // Dialogs can also be created using templateUrl and controller as distinct arguments:
            //
            //     var d = new Dialog('path/to/dialog.html', MyDialogCtrl);
            ...
            Dialog.prototype.open = function(templateUrl, controller){
                ...
                this._loadResolves().then(function(locals){
                    ...
                    if (self.options.controller) {
                        ...
                        self.modalEl.contents().data('ngCtrlCtrl', ctrl);
                    }
            ...
            return {
                ...
                messageBox: function(title, message, buttons){
                    return new Dialog({templateUrl: 'template/dialog/message.html', controller: 'MessageBoxCtrl', resolve: {model: function(){
                        return {
                            title: title,
                            message: message,
                            buttons: buttons
        ...
        return {
            ...
            link: function(scope, element, attrs){
                ...
                element.parent().bind('click', function(event){
                    if ($(event.target).closest(".autocomplete").length == 0 && close) {
                        close();
                    }
                });
...
angular.module('ui.bootstrap.tabs', [])
    .controller('TabsCtrl', ['$scope', '$element', function($scope, $element){
