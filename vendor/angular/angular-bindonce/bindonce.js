(function () {
    ...
    /**
     * @ngdoc directive
     * @name ng.directive:boText
     * @element ANY
     * @param {expression} boText
     */
    /**
     * @ngdoc directive
     * @name ng.directive:boShow
     * @element ANY
     * @param {expression} boShow
     */
    /**
     * @ngdoc directive
     * @name ng.directive:boHide
     * @element ANY
     * @param {expression} boHide
     */
    /**
     * @ngdoc directive
     * @name ng.directive:boSrc
     * @element ANY
     * @param {expression} boSrc
     */
    /**
     * @ngdoc directive
     * @name ng.directive:boHref
     * @element ANY
     * @param {expression} boHref
     */



    var bindonceModule = angular.module('bindonce', []);
