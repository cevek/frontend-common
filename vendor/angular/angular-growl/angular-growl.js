...
function growl() {}
growl.prototype = {
    addWarnMessage: function (text, config) {},
    addErrorMessage: function (text, config) {},
    addInfoMessage: function (text, config) {},
    addSuccessMessage: function (text, config) {},
    addServerMessages: function (messages) {},
    onlyUnique: function () {}
};